...
<head>
    ...
    <title>Register - Warung Bali Sangeh</title>
...
<body class="bg-stone-900 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md relative z-10">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-green-400 max-w-xs mx-auto text-sm uppercase tracking-widest">Admin Registration</p>
        </div>
        ...
        <div class="bg-stone-900/80 backdrop-blur-md border border-stone-700/50 rounded-2xl shadow-2xl p-8">
            ...
            <form action="{{ route('register.post') }}" method="POST">
                ...
                <!-- Confirm Password -->
                <div class="mb-6">
                    <label for="password_confirmation" class="block text-sm font-medium text-stone-300 mb-2">
                        Konfirmasi Password
                    </label>
